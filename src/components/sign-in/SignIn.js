...
const SignIn = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full mt-40 max-w-md px-4 py-8 bg-white rounded-lg shadow dark:bg-gray-800 sm:px-6 md:px-8 lg:px-10">
